...
void ForwardTravelWrite(TreeNode* start, TreeNode* root)//前序遍历，NOT_SHOW用于控制输出时不输出某些在树内存在的内容
{
	if (start != NULL)//递归思路
	{
		ofstream write("C:\\2151601\\目录文件.txt", ifstream::out | ifstream::app);//建立文件
		if (write.fail()) {
			cout << "文件操作失败,请确保代码运行环境正常" << endl;
			exit(0);
		}
...
void buildTree(BinaryTree& BUILDFILE) {
	...
	ifstream read("C:\\2151601\\目录文件.txt");//读文件
	if (read.fail()) {
		cout << "文件打开失败,请确保代码运行环境正常" << endl;
		exit(0);
	}
...
void DiskWrite()
{
	ofstream write("C:\\2151601\\磁盘文件.txt", ifstream::out);//建立文件
	if (write.fail()) {
		cout << "文件操作失败,请确保代码运行环境正常" << endl;
		exit(0);
	}
...
void BitMapWrite()
{
	ofstream write("C:\\2151601\\位图文件.txt", ifstream::out);//建立文件
	if (write.fail()) {
		cout << "文件操作失败,请确保代码运行环境正常" << endl;
		exit(0);
	}
...
void DiskRead()
{
	ofstream write("C:\\2151601\\磁盘文件.txt", ifstream::out | ifstream::app);//建立文件
	if (write.fail()) {
		cout << "文件操作失败,请确保代码运行环境正常" << endl;
		exit(0);
	}
	...
	ifstream read("C:\\2151601\\磁盘文件.txt", ifstream::in);//建立文件
	if (read.fail()) {
		cout << "文件操作失败,请确保代码运行环境正常" << endl;
		exit(0);
	}
...
void BitMapRead()
{
	ofstream write("C:\\2151601\\位图文件.txt", ifstream::out | ifstream::app);//建立文件
	if (write.fail()) {
		cout << "文件操作失败,请确保代码运行环境正常" << endl;
		exit(0);
	}
	...
	ifstream read("C:\\2151601\\位图文件.txt", ifstream::in);//建立文件
	if (read.fail()) {
		cout << "文件操作失败,请确保代码运行环境正常" << endl;
		exit(0);
	}
...
int main() {
	...
	ofstream write("C:\\2151601\\目录文件.txt", ifstream::out);//建立文件
	if (write.fail()) {
		cout << "文件操作失败,请确保代码运行环境正常" << endl;
		exit(0);
	}
